...
//    Activity activity;
    ...
    public UVCCamera(CameraManager cameraManager, CameraName cameraName, Callback frameCallback) {
...
//        cameraMonitorViewId = context.getResources().getIdentifier("cameraMonitorViewId", "id", context.getPackageName());
    ...
    public static UVCCamera getCamera(Callback callback) {
    ...
    CameraCaptureSession.StateCallback captureStateCallback = new CameraCaptureSession.StateCallbackDefault() {
        ...
        public void onConfigured(@NonNull CameraCaptureSession session) {
            ...
            try {
                ...
                CameraCaptureSequenceId cameraCaptureSequenceId = session.startCapture(cameraCaptureRequest, new WebcamCaptureCallback(cameraCaptureRequest, frameCallback), // callback, not continuation; avoids copying frame
...
//            RobotLog.vv(TAG, "capture session reports closed: %s", session);
    ...
    public class WebcamCaptureCallback implements CameraCaptureSession.CaptureCallback {
        ...
        public WebcamCaptureCallback(CameraCaptureRequest request, Callback callback) {
